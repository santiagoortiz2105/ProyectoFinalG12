...
public class FrmSesion extends javax.swing.JInternalFrame {
    ...
    private String instalacionesToString(List<Instalacion> lista, Tratamiento tratamiento) {
        ...
        try {
            for (Instalacion inst : lista) {
                ...
                //agreamos el nombre de la instalacion
    ...
    private void cargarTabla() {
        ...
        for (Sesion s : sesionData.listarSesiones()) {
            ...
            double montoTotal = montoInstalaciones + montoTratamiento;
    ...
    private void jBotonModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBotonModificarActionPerformed
        try {
            ...
            //actualizamos valores de la sesion
    ...
    private void jBotonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBotonBuscarActionPerformed
        try {
            ...
            if (s != null) {
                ...
                //traemos desde la db las instalaciones de la sesion
                List<Instalacion> instalacionesSesion = instalacionData.obtenerInstalacionesPorSesion(s.getCodSesion());

                //sacamos cualquier seleccion previa
                listaInstalaciones.clearSelection();

                //marcamos en la JList las instalaciones que pertenecen a la sesion
    ...
    private Tratamiento obtenerTratamientoSeleccionado() {
        System.out.println("Entrando a obtener tratamientos...");
    ...
    private LocalDateTime[] parsearFechas(String fechaStr, String horarioStr) throws DateTimeParseException {
        ...
        //parseamos el horario (HH:mm - HH:mm)
        ...
        listaInstalaciones.setSelectionModel(new DefaultListSelectionModel() {
            ...
            public void setSelectionInterval(int index0, int index1) {
                if (index0 == index1) {
                    ...
                    //permite seleccionar varios si arrastra
                    super.setSelectionInterval(index0, index1);
                }
            }
        });

        //para que no robe foco
    ...
    private void soloFechaHora(javax.swing.JTextField campo) {
        campo.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                ...
                //solo numeros, guiones, slash, espacio y dos puntos
